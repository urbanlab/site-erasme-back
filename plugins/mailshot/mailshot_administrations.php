...
function mailshot_upgrade($nom_meta_base_version, $version_cible) {
	...
	$maj['0.3.7'] = array(
		array('maj_tables', array('spip_mailshots')), // date_alerte_fail
	);

	$maj['0.4.1'] = array(
		array('sql_alter', 'TABLE spip_mailshots_destinataires ADD raw_feedback varchar(25) DEFAULT "" NOT NULL AFTER statut'),
	);
