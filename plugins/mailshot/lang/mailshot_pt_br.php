...
O envio rápido é desaconselhado por aumentar o risco de ser classificado como SPAM.',
	'explication_check_fail_ratio' => 'Se a margem de falha ultrapassar @ratio@% os envios serão suspensos e um e-mail será enviado ao webmaster para verificação do serviço de envio',
...
Isto pode representar um volume importante de dados; se você faz muitos envios, é aconselhávek purgar o detalhe dos envios antigos,',
	...
	'info_statut_destinataire_kill' => 'Anulado',
	...
	'label_check_fail_ratio_oui' => 'Monitoramento da margem de falha',
	...
	// M
	'mail_alerte_fail_ratio_sujet' => '[Mailshot #@id@] ALERTA margem de falha de envio de e-mails',
	'mail_alerte_fail_ratio_texte' => 'Uma margem de falha anormal de @ratio@% foi detectada para o envio de e-mails em massa #@id@. Todos os envios estão suspensos. Acesse o site @url@ para verificar o seu serviço de envio.',
	'mailshot_titre' => 'MailShot',
	'message_admin_alerte_fail_ratio' => 'Em @date@ uma margem de falhas anormal foi detectada no envio de e-mails em massa.<br />
...
Verifique o seu serviço de envio antes de reativar os envios.',
	...
	'titre_envois_destinataires_kill' => 'Envios cancelados',
