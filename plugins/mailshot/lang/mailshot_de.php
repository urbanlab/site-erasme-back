...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'explication_check_fail_ratio' => 'Wenn die Fehlerrate @ratio@% überschreitet, wird der Versand ausgesetzt und eine E-Mail an den Webmaster gesendet, um den Versand zu überprüfen ',
...
Dies führt bei zahlreichem Versenden zu einer großen Datenmenge, weshalb es ratsam ist diese Versanddetails nach einer gewissen Zeit zu löschen.',
	...
	'info_statut_destinataire_kill' => 'Abgebrochen',
	...
	'label_check_fail_ratio_oui' => 'Überwachung der Fehlerrate',
	...
	'label_envoi' => 'Versand',
	'label_from' => 'Absender',
	'label_graceful' => 'Nur Empfänger, die diesen Inhalt nicht bereits erhalten haben ',
	...
	// M
	'mail_alerte_fail_ratio_sujet' => '[Mailshot #@id@] ALERT hohe Fehlerrate beim Mailversand',
	'mail_alerte_fail_ratio_texte' => 'Eine abnormale Fehlerrate von @ratio@% wurde beim  Massenmailversand #@id@ festgestellt. Alle Sendungen werden pausiert. Bitte verbinden Sie sich mit der Website @url@ um Ihren Versanddienst zu überprüfen. ',
	'mailshot_titre' => 'MailShot',
	'message_admin_alerte_fail_ratio' => 'Am @date@ wurde eine abnormale Fehlerrate beim Versand von Massenmails festgestellt. <br />Alle Sendungen sind ausgesetzt. <br /> Überprüfen Sie Ihren Versanddienst, bevor Sie die Sendungen wieder aktivieren. ',
	...
	'titre_envois_destinataires_clic' => 'Angeklickte Mails',
	...
	'titre_envois_destinataires_kill' => 'Abgebrochene Sendungen',
	'titre_envois_destinataires_ok' => 'Erfolgreiche Sendungen',
	'titre_envois_destinataires_read' => 'Geöffnete Mails',
	'titre_envois_destinataires_sent' => 'Erfolgreiche Sendungen',
	'titre_envois_destinataires_spam' => 'Spam-E-Mails',
