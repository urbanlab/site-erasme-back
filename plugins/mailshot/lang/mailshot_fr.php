...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'explication_check_fail_ratio' => 'Si le taux d’échec dépasse @ratio@% les envois seront suspendus et un mail sera envoyé au webmestre pour vérification du service d’envoi',
	...
	'info_statut_destinataire_kill' => 'Annulé',
	...
	'label_check_fail_ratio_oui' => 'Surveillance du taux d’échec',
	...
	'label_sendinblue_api_key' => 'Brevo APIv3 Key',
	...
	// M
	'mail_alerte_fail_ratio_sujet' => '[Mailshot #@id@] ALERTE taux d’echec d’envoi des mails',
	'mail_alerte_fail_ratio_texte' => 'Un taux d’echec anormal de @ratio@% a été détecté sur l’envoi de mails en nombre #@id@. Tous les envois sont en pause. Connectez vous sur le site @url@ pour vérifier votre service d’envoi.',
	'mailshot_titre' => 'MailShot',
	'message_admin_alerte_fail_ratio' => 'Le @date@ un taux d’echec anormal a été détecté sur l’envoi de mails en nombre. <br />Tous les envois sont suspendus. <br />Vérifiez votre service d’envoi avant de réactiver les envois.',
	...
	'titre_envois_destinataires_kill' => 'Envois annulés',
