...
<div class="colorPicker" style="background:#d2513c">#D2513C</div>
	...
	$champs['spip_rubriques']['fieldset_1'] = [
		'saisie' => 'fieldset',
		'options' => [
			'nom' => 'fieldset_1',
			'label' => 'Contenus supplémentaires',
		...
		'saisies' => [
			'titre_section_supplementaire_1' => [
				'saisie' => 'input',
				'options' => [
					'nom' => 'titre_section_supplementaire_1',
					'label' => 'Titre de la section supplementaire n°1',
					'type' => 'text',
					'size' => '40',
					'autocomplete' => 'defaut',
					'sql' => 'text DEFAULT \'\' NOT NULL',
			...
			'texte_section_supplementaire_1' => [
				'saisie' => 'textarea',
				'options' => [
					'nom' => 'texte_section_supplementaire_1',
					'label' => 'Texte de la section supplementaire n°1',
					'rows' => '5',
					'cols' => '40',
					'sql' => 'text DEFAULT \'\' NOT NULL',
					'rechercher' => 'on',
			...
			'titre_section_supplementaire_2' => [
				'saisie' => 'input',
				'options' => [
					'nom' => 'titre_section_supplementaire_2',
					'label' => 'Titre de la section supplementaire n°2',
					'type' => 'text',
					'size' => '40',
					'autocomplete' => 'defaut',
					'sql' => 'text DEFAULT \'\' NOT NULL',
			...
			'texte_section_supplementaire_2' => [
				'saisie' => 'textarea',
				'options' => [
					'nom' => 'texte_section_supplementaire_2',
					'label' => 'Texte de la section supplementaire n°2',
					'rows' => '5',
					'cols' => '40',
					'sql' => 'text DEFAULT \'\' NOT NULL',
					'rechercher' => 'on',
			...
			'titre_section_chiffres_cles' => [
				'saisie' => 'input',
				'options' => [
					'nom' => 'titre_section_chiffres_cles',
					'label' => 'Titre de la section chiffres clés',
					'type' => 'text',
					'size' => '40',
					'autocomplete' => 'defaut',
					'sql' => 'text DEFAULT \'\' NOT NULL',
			...
			'texte_section_chiffres_cles' => [
				'saisie' => 'textarea',
				'options' => [
					'nom' => 'texte_section_chiffres_cles',
					'label' => 'Texte de la section chiffres clés',
					'rows' => '5',
					'cols' => '40',
					'sql' => 'text DEFAULT \'\' NOT NULL',
					'rechercher' => 'on',
			...
			'data_section_chiffres_cles' => [
				'saisie' => 'textarea',
				'options' => [
					'nom' => 'data_section_chiffres_cles',
					'label' => 'Data section chiffres clés',
					'explication' => 'Rajouter l\'indication suivant sur le champ: "Indiquer chaque chiffre clé sous la forme "123 : jours de travail sur ce projet". Les deux points ( : ) ne sont pas affichés et ne servent que pour indiquer la division entre les 2 parties; une phase par ligne"',
					'rows' => '5',
					'cols' => '40',
					'sql' => 'text DEFAULT \'\' NOT NULL',
					'rechercher' => 'on',
			...
			'titre_section_stades_dev' => [
				'saisie' => 'input',
				'options' => [
					'nom' => 'titre_section_stades_dev',
					'label' => 'Titre de la section stades de développement',
					'type' => 'text',
					'size' => '40',
					'autocomplete' => 'defaut',
					'sql' => 'text DEFAULT \'\' NOT NULL',
			...
			'texte_section_stades_dev' => [
				'saisie' => 'textarea',
				'options' => [
					'nom' => 'texte_section_stades_dev',
					'label' => 'Texte de la section stades de développement',
					'rows' => '5',
					'cols' => '40',
					'sql' => 'text DEFAULT \'\' NOT NULL',
					'rechercher' => 'on',
			...
			'data_section_chiffres_cles' => [
				'saisie' => 'textarea',
				'options' => [
					'nom' => 'data_section_stades_dev',
					'label' => 'Data section stades de développement',
					'explication' => 'Rajouter l\'indication suivant sur le champ: "Indiquer chaque phase de développement sous la forme "2016 : conception". Les deux points ( : ) ne sont pas affichés et ne servent que pour indiquer la division entre les 2 parties; une phase par ligne ; préciser la(les) phase(s) à mettre en évidence précédant la ligne d\'un crochet ">" sous la forme "> 2018 : incubation"',
					'rows' => '5',
					'cols' => '40',
					'sql' => 'text DEFAULT \'\' NOT NULL',
					'rechercher' => 'on',
