...
function newsletters_declarer_tables_objets_sql($tables) {
	...
	$tables['spip_newsletters'] = array(
		...
		'field'=> array(
			...
			// pour forcer une des urls du site dans les urls de la newsletter si besoin
			"adresse_site" => "text DEFAULT '' NOT NULL",
		...
		'date' => "date",
		'champs_editables'  => array('titre','chapo','texte','date_redac','patron','baked','html_email','texte_email','html_page','recurrence','email_test','liste','adresse_envoi_nom', 'adresse_envoi_email', 'adresse_site'),
		'champs_versionnes' => array('titre','chapo','texte','date_redac','patron','recurrence','email_test','liste','adresse_envoi_nom', 'adresse_envoi_email', 'adresse_site'),
		'rechercher_champs' => array('titre' => 8, 'chapo' => 3, 'texte' => 2),
