...
### d. Utilisation du plugin **identifiants**

Le plugin graphql peut utiliser le plugin [identifiants](https://git.spip.net/spip-contrib-extensions/identifiants) ce qui permet d'utiliser un _slug_ pour identifier un objet à la place de son ID.
