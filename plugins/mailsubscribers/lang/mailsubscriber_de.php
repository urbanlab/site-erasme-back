...
@url_confirmsubscribe@',
	...
	'explication_listes_diffusion_option_identifiant' => 'Nur die folgenden Listen vorschlagen (alle abwählen, um alle Listen vorzuschlagen)',
	'explication_listes_diffusion_option_statut' => 'Listen nach ihrem Status filtern',
	'explication_listes_diffusion_option_titre_prive_uniquement' => 'Standardmäßig wird der öffentliche Titel von Listen angezeigt',
	...
	// L
	'label_case_listes_diffusion_option_autoriser_aucune' => 'Option "Keine Liste" anbieten ',
	'label_case_listes_diffusion_option_titre_prive_uniquement' => 'Immer den internen Titel verwenden',
	...
	'label_lang' => 'Sprache',
	'label_listes' => 'Listen',
	'label_listes_diffusion_option_identifiant' => 'Auf bestimmte Listen einschränken ',
	...
	// R
	'reconsent_confirmsubscribe_interet' => 'Wir möchten überprüfen, ob sie diese E-Mails von uns erhalten möchten.',
	'reconsent_confirmsubscribe_sujet_email' => '[@nom_site_spip@] Vérification d’inscription à la Newsletter',
	'reconsent_confirmsubscribe_texte_email_1' => 'Sie haben den Newsletter von @nom_site_spip@ mit der E-Mail-Adresse @email@ abonniert.',
	'reconsent_confirmsubscribe_texte_email_2' => 'Bitte geben Sie Ihre Entscheidung an, indem Sie auf einen der folgenden Links klicken:
@url_reconsent_confirmsubscribe@',
	'reconsent_confirmsubscribe_texte_email_3' => 'Wenn Sie diese E-Mail ignorieren, werden Sie in einigen Tagen automatisch abgemeldet.',
	'reconsent_confirmsubscribe_texte_email_envoye' => 'Eine Bestätigungsmail wurde an die Mailadresse geschickt.',
	'reconsent_confirmsubscribe_texte_email_liste_1' => 'Sie sind mit der E-Mailadresse @email@ für den Newsletter "@titre_liste@" von @nom_site_spip@ angemeldet.',
	'reconsent_confirmsubscribe_texte_email_listes_1' => 'Sie sind mit der E-Mailadresse @email@ für die Newsletter "@titre_liste@" von @nom_site_spip@ angemeldet.',
	'reconsent_confirmsubscribe_titre_email' => 'Überprüfung der Anmeldung für den Newsletter',
	'reconsent_confirmsubscribe_titre_email_liste' => 'Überprüfung der Anmeldung für den Newsletter "<b>@titre_liste@</b>"',
	'reconsent_confirmsubscribe_titre_email_listes' => 'Überprüfung der Anmeldung zu Newslettern',
	'reconsent_subscribe_deja_texte' => 'Die E-Mail-Adresse @email@ ist nicht für diesen Newsletter angemeldet.',
	'reconsent_subscribe_texte_confirmer_email_1' => 'Bitte bestätigen Sie die Anmeldung der E-Mail-Adresse @email@, indem Sie auf die Schaltfläche klicken:',
	'reconsent_subscribe_texte_confirmer_email_liste_1' => 'Bitte bestätigen Sie die Anmeldung der E-Mail-Adresse @email@ für den Newsletter <b>@titre_liste@</b>, indem Sie auf die Schaltfläche klicken:',
	'reconsent_subscribe_texte_confirmer_email_listes_1' => 'Bitte bestätigen Sie die Anmeldung der E-Mail-Adresse @email@ für die Newsletter <b>@titre_liste@</b>, indem Sie auf die Schaltfläche klicken:',
	'reconsent_subscribe_texte_email_1' => 'Vielen Dank für die Verlängerung Ihres Abonnements unseres Newsletters mit der E-Mail-Adresse @email@',
	'reconsent_subscribe_texte_email_liste_1' => 'Vielen Dank für die Verlängerung Ihres Abonnements des Newsletter "@titre_liste@" mit der E-Mail-Adresse @email@.',
	'reconsent_subscribe_texte_email_listes_1' => 'Vielen Dank für die Verlängerung Ihres Abonnements der Newsletter "@titre_liste@" mit der E-Mail-Adresse @email@',
	...
	'titre_export_mailsubscribers_out' => 'Abmeldungen exportieren',
	...
	'titre_mailsubscriber' => 'Abonnieren Sie unseren Newsletter',
