...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'bouton_invitation' => 'Пригласить подписаться на рассылку',
	'bouton_previsu_importer' => 'Предварительный просмотр',

	// C
	'confirmsubscribe_invite_texte_email_1' => '@invite_email_from@ приглашает вас подписаться на рассылку с сайта @nom_site_spip@ на емейл @email@.',
...
@url_confirmsubscribe@',
	...
	// F
	'force_synchronisation' => 'Синхронизировать',
	...
	'info_email_obligatoire' => 'Обязательный емейл',
	...
	'label_optin' => 'Opt-in',
	'label_statut' => 'Статус',
	'label_to_email' => 'Отправить приглашение',
	...
	// R
	'reconsent_confirmsubscribe_texte_email_envoye' => 'На вашу почту отправлен лист с подтверждением',
	'reconsent_subscribe_deja_texte' => '@email@ отсутствует в базе подписчиков.',
...
@url_unsubscribe@',
	...
	'titre_recherche_email' => 'Емейл « @email@ »',
	'titre_recherche_envois' => 'Отправить  « @email@ »',

	// U
	'unsubscribe_deja_texte' => '@email@ отсутствует в базе подписчиков.',
	'unsubscribe_sujet_email' => '[@nom_site_spip@] Отписаться от рассылки',
