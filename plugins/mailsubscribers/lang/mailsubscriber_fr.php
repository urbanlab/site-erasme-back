...
@url_confirmsubscribe@',
	...
	// L
	'label_case_listes_diffusion_option_autoriser_aucune' => 'Proposer une option « Aucune liste »',
	...
	'label_lang' => 'Langue',
	'label_listes' => 'Listes',
	'label_listes_diffusion_option_identifiant' => 'Restreindre à certaines listes',
	...
	// R
	'reconsent_confirmsubscribe_interet' => 'Nous souhaitons vérifier votre intérêt à recevoir ces courriels de notre part.',
	'reconsent_confirmsubscribe_sujet_email' => '[@nom_site_spip@] Vérification d’inscription à la Newsletter',
	'reconsent_confirmsubscribe_texte_email_1' => 'Vous êtes inscrit·e à la Newsletter de @nom_site_spip@ avec l’adresse email @email@.',
...
@url_reconsent_confirmsubscribe@',
	'reconsent_confirmsubscribe_texte_email_3' => 'Si vous ignorez ce mail, vous serez automatiquement désinscrit·e dans quelques jours.',
	'reconsent_confirmsubscribe_texte_email_envoye' => 'Un email a été envoyé à cette adresse pour confirmation.',
	'reconsent_confirmsubscribe_texte_email_liste_1' => 'Vous êtes inscrit·e à la newsletter « @titre_liste@ » de @nom_site_spip@ avec l’adresse email @email@.',
	'reconsent_confirmsubscribe_texte_email_listes_1' => 'Vous êtes inscrit·e aux newsletters « @titre_liste@ » de @nom_site_spip@ avec l’adresse email @email@.',
	'reconsent_confirmsubscribe_titre_email' => 'Vérification d’inscription à la Newsletter',
	'reconsent_confirmsubscribe_titre_email_liste' => 'Vérification d’inscription à la newsletter « <b>@titre_liste@</b> »',
	'reconsent_confirmsubscribe_titre_email_listes' => 'Vérification d’inscription aux newsletters ',
	'reconsent_subscribe_deja_texte' => 'L’adresse email @email@ n’est pas inscrite à cette newsletter',
	'reconsent_subscribe_texte_confirmer_email_1' => 'Veuillez confirmer l’inscription de l’adresse email @email@ en cliquant sur le bouton : ',
	'reconsent_subscribe_texte_confirmer_email_liste_1' => 'Veuillez confirmer l’inscription de l’adresse email @email@ à la newsletter <b>@titre_liste@</b> en cliquant sur le bouton : ',
	'reconsent_subscribe_texte_confirmer_email_listes_1' => 'Veuillez confirmer l’inscription de l’adresse email @email@ aux newsletters <b>@titre_liste@</b> en cliquant sur le bouton : ',
	'reconsent_subscribe_texte_email_1' => 'Nous avons bien pris en compte le prolongement de votre inscription à notre Newsletter avec l’adresse email @email@.',
	'reconsent_subscribe_texte_email_liste_1' => 'Nous avons bien pris en compte le prolongement de votre inscription à la newsletter « @titre_liste@ » avec l’adresse email @email@.',
	'reconsent_subscribe_texte_email_listes_1' => 'Nous avons bien pris en compte le prolongement de votre inscription aux newsletters « @titre_liste@ » avec l’adresse email @email@.',
...
@url_unsubscribe@',
	...
	'titre_export_mailsubscribers_out' => 'Exporter les désinscrits',
