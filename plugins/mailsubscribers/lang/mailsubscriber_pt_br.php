...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'explication_listes_diffusion_option_identifiant' => 'Só propor as listas a seguir (desmarque tudo para propor todas as listas)',
	'explication_listes_diffusion_option_statut' => 'Filtrar as listas de acordo com o status',
	'explication_listes_diffusion_option_titre_prive_uniquement' => 'Por padrão, a entrada exibe o título público das listas, caso existam.',
	...
	// L
	'label_case_listes_diffusion_option_autoriser_aucune' => 'Propor uma opção «Nenhuma lista»',
	'label_case_listes_diffusion_option_titre_prive_uniquement' => 'Usar sempre o título privado',
	...
	'label_lang' => 'Idioma',
	'label_listes' => 'Listas',
	'label_listes_diffusion_option_identifiant' => 'Restringir a certas listas',
	...
	// R
	'reconsent_confirmsubscribe_interet' => 'Queremos verificar o seu interesse em receber as nossas mensagens.',
	'reconsent_confirmsubscribe_sujet_email' => '[@nom_site_spip@] Verificação de assinatura da Newsletter',
	'reconsent_confirmsubscribe_texte_email_1' => 'Você assinou a Newsletter de @nom_site_spip@ com o endereço de e-mail @email@.',
	'reconsent_confirmsubscribe_texte_email_2' => 'Por favor indique a sua escolha clicando em um dos links abaixo:
@url_reconsent_confirmsubscribe@',
	'reconsent_confirmsubscribe_texte_email_3' => 'Se você ignorar esta mensagem, sua assinatura será cancelada automaticamente em alguns dias.',
	'reconsent_confirmsubscribe_texte_email_envoye' => 'Um e-mail foi enviado nesse endereço para confirmação.',
	'reconsent_confirmsubscribe_texte_email_liste_1' => 'Você assinou a newsletter « @titre_liste@ » de @nom_site_spip@ com o endereço de e-mail @email@.',
	'reconsent_confirmsubscribe_texte_email_listes_1' => 'Você assinou as newsletters « @titre_liste@ » de @nom_site_spip@ com o endereço de e-mail @email@.',
	'reconsent_confirmsubscribe_titre_email' => 'Verificação de assinatura da Newsletter',
	'reconsent_confirmsubscribe_titre_email_liste' => 'Verificação de assinatura da newsletter « <b>@titre_liste@</b> »',
	'reconsent_confirmsubscribe_titre_email_listes' => 'Verificação de assinatura das newsletters ',
	'reconsent_subscribe_deja_texte' => 'O endereço de e-mail @email@ não é assinante desta newsletter.',
	'reconsent_subscribe_texte_confirmer_email_1' => 'Por favor clique no botão abaixo para confirmar a assinatura com o e-mail @email@: ',
	'reconsent_subscribe_texte_confirmer_email_liste_1' => 'Por favor clique no botão abaixo para confirmar a assinatura com o e-mail @email@ da newsletter <b>@titre_liste@</b>: ',
	'reconsent_subscribe_texte_confirmer_email_listes_1' => 'Por favor clique no botão abaixo para confirmar a assinatura do e-mail @email@ das newsletters <b>@titre_liste@</b>: ',
	'reconsent_subscribe_texte_email_1' => 'Obrigado por renovar a sua assinatura da nossa Newsletter com o endereço de e-mail @email@.',
	'reconsent_subscribe_texte_email_liste_1' => 'Obrigado por renovar a assinatura da  newsletter « @titre_liste@ » com o endereço de e-mail @email@.',
	'reconsent_subscribe_texte_email_listes_1' => 'Obrigado por renovar a assinatura das newsletters « @titre_liste@ » com o endereço de e-mail @email@.',
...
@url_unsubscribe@',
	...
	'titre_export_mailsubscribers_out' => 'Exportar os desinscritos',
